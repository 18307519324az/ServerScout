...
function AssetRedirect() {
  ...
  return <Navigate to={id ? `/asset-management/${id}` : '/asset-management'} replace />
}
    ...
    <ErrorBoundary>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<AuthGuard><ModeProvider><MainLayout /></ModeProvider></AuthGuard>}>
            <Route path="/dashboard" element={<DashboardPage />} />
            <Route path="/asset-management" element={<AssetListPage />} />
            <Route path="/asset-management/:id" element={<AssetDetailPage />} />
            <Route path="/assets" element={<Navigate to="/asset-management" replace />} />
            <Route path="/assets/:id" element={<AssetRedirect />} />
