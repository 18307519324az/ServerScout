        ...
        {selectedNode && (
          <div className="w-72 border-l dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 overflow-y-auto flex-shrink-0">
            ...
            <div className="p-4 space-y-0">
              ...
              <div className="pt-4">
                <button onClick={() => navigate(`/asset-management/${selectedNode.id}`)} className="w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
