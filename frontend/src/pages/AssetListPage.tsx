            ...
            {assets.map((a: any) => (
              <div key={a.id} className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 shadow-sm p-4">
                <div className="flex items-center justify-between mb-2">
                  <Link to={`/asset-management/${a.id}`} className="text-blue-600 dark:text-blue-400 font-medium font-mono">
                    {a.ipAddress}
                  </Link>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    {a.openPortCount > 0 ? (
                      <Link to={`/asset-management/${a.id}?section=ports`} className="font-mono text-blue-600 dark:text-blue-400 hover:underline">
                        {a.openPortCount}
                      </Link>
                    ) : (
                  ...
                  <tr key={a.id} className="border-t dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <Link to={`/asset-management/${a.id}`} className="text-blue-600 dark:text-blue-400 hover:underline font-medium font-mono">
                          {a.ipAddress}
                        </Link>
                        {a.isHoneypot && (
                    ...
                    <td className="px-4 py-3 text-center font-mono">
                      {a.openPortCount > 0 ? (
                        <Link to={`/asset-management/${a.id}?section=ports`} className="text-blue-600 dark:text-blue-400 hover:underline">
                          {a.openPortCount}
                        </Link>
                      ) : (
