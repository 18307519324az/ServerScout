...
public class WebhookNotificationService {
    ...
    /**
     * Check whether at least one webhook platform has a configured URL.
     * Used by the execution service to decide NOTIFICATION stage status.
     */
    public boolean isConfigured() {
        return !configService.getConfig("webhook-dingtalk", "").isEmpty()
                || !configService.getConfig("webhook-feishu", "").isEmpty()
                || !configService.getConfig("webhook-wecom", "").isEmpty();
    }
